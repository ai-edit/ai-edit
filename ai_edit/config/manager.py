...
class ConfigManager:
    ...
    DEFAULT_CONFIG = {
        ...
        "general": {
            "verbose": False,
            "editor": None  # Will use $EDITOR or default
        }
    }
    ...
    def set_config(self, key: str, value: Any) -> None:
        ...
        if key in ["context.max_files", "context.max_tokens"]:
            value = int(value)
        elif key in ["safety.require_confirmation", "safety.create_backups", "safety.dry_run_default", "general.verbose"]:
