...
@click.pass_context
def edit(ctx, description: str, dry_run: bool, backup: bool, interactive: bool):
...
def main():
    ...
    try:
        ...
        if len(sys.argv) > 1 and not sys.argv[1].startswith('-') and sys.argv[1] not in ['init', 'config', 'status', 'edit']:
            # Insert 'edit' command
